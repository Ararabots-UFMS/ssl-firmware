...
#define INT_GPIO_PORT_XL INT1_GPIO_Port
#define INT_PIN_XL INT1_Pin
#define INT_GPIO_PORT_G INT1_GPIO_Port
#define INT_PIN_G INT2_Pin
...
int8_t lsm6ds3_init(lsm6ds3_settings_t lsm6ds3_settings, SPI_HandleTypeDef hspi2) {
